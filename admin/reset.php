...
if (!empty($_POST)) {
  if (array_key_exists('username',$_POST) && $_POST['username'] == $username && array_key_exists('email',$_POST) && $_POST['email'] == $email) {
    if ($google_auth == '0' || (array_key_exists('google_auth',$_POST) && (verifykey($_POST['google_auth'],30,1) || $_POST['otp'] == $otp_recovery_code))) {
